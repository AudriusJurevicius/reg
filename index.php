...
<html lang="en">
  <head>
    ...
    <title>Poker Room Operations</title>
  </head>
  <body>
    <div class="container">
        <!--Navigation script-->
        ...
        <div class="container">
          <div class="jumbotron">
            <p class="h2">Poker Room Operations</p>
            <p>A very basic work station for us, no databases involved yet, so everything needs to be updated by me.</p>
          </div>
        </div>
		<div class="container">
			<div class="row">
